...
module.exports = {
  ...
  fetchAllIngredients: function fetchAllIngredients(state, _, actions) {
    fetch('http://localhost:3000/allIngredients').then(function (data) {
      return data.json();
    }).then(function (data) {
...
module.exports = {
  ...
  fetchDrinkById: function fetchDrinkById(state, id, actions) {
    fetch('http://localhost:3000/drink/' + id).then(function (data) {
      return data.json();
    }).then(function (data) {
...
module.exports = {
  ...
  fetchDrinksByIngredients: function fetchDrinksByIngredients(state, ingredients, actions) {
    ...
    fetch('http://localhost:3000/filter?ingredients=' + ingredientsCSV + '&limit=' + limit).then(function (data) {
      return data.json();
    }).then(function (data) {
...
},{"tram-one":16}],6:[function(require,module,exports){
'use strict';
...
},{"tram-one":16}],7:[function(require,module,exports){
'use strict';
...
},{"tram-one":16}],8:[function(require,module,exports){
'use strict';
...
},{"combobox-node":15,"tram-one":16}],9:[function(require,module,exports){
'use strict';
...
},{"./actions/all-ingredients":1,"./actions/drink-by-id":2,"./actions/filter-by-ingredients":3,"./actions/selected-ingredients":4,"./pages/404":10,"./pages/about":11,"./pages/drink":12,"./pages/filter":13,"./pages/home":14,"tram-one":16}],10:[function(require,module,exports){
'use strict';
...
},{"../elements/header":7,"tram-one":16}],11:[function(require,module,exports){
'use strict';
...
},{"../elements/header":7,"tram-one":16}],12:[function(require,module,exports){
'use strict';
...
},{"../elements/drink":6,"../elements/header":7,"tram-one":16}],13:[function(require,module,exports){
'use strict';
...
},{"../elements/drink-preview":5,"../elements/header":7,"tram-one":16}],14:[function(require,module,exports){
'use strict';
...
},{"../elements/header":7,"../elements/select-ingredients":8,"tram-one":16}],15:[function(require,module,exports){
